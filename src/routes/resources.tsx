...
const EXTRA_RESOURCES: ExtraResource[] = [
  { title: "ICLEI South Asia — Net-Zero Framework", url: "https://southasia.iclei.org/", source: "ICLEI", tags: ["framework", "methodology"], description: "Guidance and framework adopted by several Indian cities for CAP development and net-zero pathways." },
  { title: "C40 Cities Climate Action Planning Framework", url: "https://www.c40.org/what-we-do/scaling-up-climate-action/climate-action-planning/", source: "C40", tags: ["framework", "methodology"], description: "Global framework for developing 1.5°C-aligned Climate Action Plans." },
  { title: "GHG Protocol for Cities (GPC)", url: "https://ghgprotocol.org/ghg-protocol-cities", source: "GHG Protocol", tags: ["inventory", "methodology"], description: "Standard methodology for city-level greenhouse gas emissions inventories." },
